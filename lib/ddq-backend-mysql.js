    ...
    function heartbeat(ddqBackendInstance, recordId, callback) {
        ...
        ddqBackendInstance.connection.query(`
            ...
            [
                ...
                debug(`Completed heartbeat query owner: ${ddqBackendInstance.config.owner}, affected ${stats.affectedRows}`);
                callback(err);
            }
        );
    }
    ...
    function requeue(ddqBackendInstance, recordId, callback) {
        ...
        ddqBackendInstance.connection.query(`
            ...
            [
                ...
                debug(`Complete requeue query owner: ${ddqBackendInstance.config.owner}, affected ${stats.affectedRows}`);
                callback(err);
            }
        );
    }
    ...
    function remove(ddqBackendInstance, recordId, callback) {
        ...
        ddqBackendInstance.connection.query(`
            ...
            [
                ...
                debug(`Completed remove query owner: ${ddqBackendInstance.config.owner}, affected ${stats.affectedRows}`);
            }
        );
    }
                    ...
                    if (selErr) {
                        ...
                        ddqBackendInstance.connection.query(`
                            ...
                            [
                                ...
                                // Ignore update errors.  That means someone else grabbed the job.
                                if (updateErr || stats.affectedRows === 0) {
                                    debug(`Error claiming ${record[0].hash} for owner: ${ddqBackendInstance.config.owner}`);
                                } else {
                                    /**
