...
module.exports = (configValidation, config, crypto, EventEmitter, mysql, timers) => {
    /**
        ...
        connect() {
            ...
            */
            ...
            mysqlOptions.forEach((key) => {
                if (config[key]) {
                    connectionOptions[key] = config[key];
                }
            });

            this.connection = mysql.createconnection(mysqlOptions);
